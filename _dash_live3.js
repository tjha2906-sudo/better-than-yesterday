...
async function unlockPremiumReport() {
    ...
    if (!token) {
        setPremiumMessage(
            "Please login to Better Than Yesterday first."
        );
        return;
    }
